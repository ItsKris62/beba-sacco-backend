/**
 * Sprint 3 – Security Controller
 *
 * POST /auth/sessions/rotate          – rotate refresh token
 * GET  /auth/sessions                 – list active sessions
 * DELETE /auth/sessions/:id           – revoke a session
 * GET  /compliance/consent            – get user consents
 * POST /compliance/consent/accept     – accept ODPC consent
 */
import {
  Controller,
  Get,
